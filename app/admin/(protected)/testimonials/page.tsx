...
export default function AdminTestimonialsPage() {
  ...
  const updateTestimonial = async (testimonialId: string, updates: Partial<Testimonial>) => {
    ...
    try {
      ...
      if (updates.comment !== undefined) firestoreUpdates.comment = updates.comment;
      if (updates.rating !== undefined) firestoreUpdates.rating = updates.rating;
      if (updates.avatar_url !== undefined) firestoreUpdates.avatar_url = updates.avatar_url;
      if (updates.is_active !== undefined) firestoreUpdates.is_active = updates.is_active;

      await updateDoc(doc(db, "testimonials", testimonialId), firestoreUpdates);
